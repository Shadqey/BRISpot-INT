...
var useThemeMode = () => {
  const [mode, setMode] = (0, import_react12.useState)(getInitialMode(getThemeMode()));
...
// node_modules/flowbite-react/lib/esm/components/TextInput/TextInput.js
var TextInput = (0, import_react13.forwardRef)(({ addon, className, color = "gray", helperText, icon: Icon, rightIcon: RightIcon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var DatepickerContext = (0, import_react14.createContext)(void 0);
function useDatePickerContext() {
  const context = (0, import_react14.useContext)(DatepickerContext);
  if (!context) {
...
var Datepicker = ({
  ...
  const [isOpen, setIsOpen] = (0, import_react15.useState)(open);
  const [view, setView] = (0, import_react15.useState)(Views.Days);
  const [selectedDate, setSelectedDate] = (0, import_react15.useState)(defaultDate);
  const [viewDate, setViewDate] = (0, import_react15.useState)(defaultDate);
  const inputRef = (0, import_react15.useRef)(null);
  const datepickerRef = (0, import_react15.useRef)(null);
...
var DropdownComponent = ({ children, className, dismissOnClick = true, theme: customTheme = {}, renderTrigger, ...props }) => {
  ...
  const handleSelect = (0, import_react23.useCallback)((index3) => {
    setSelectedIndex(index3);
    setOpen(false);
  }, []);
  const handleTypeaheadMatch = (0, import_react23.useCallback)((index3) => {
    if (open) {
